...
local function _4_()
  ...
  return treesitter.setup({ensure_installed = {"java", "yaml", "bash", "kotlin", "clojure", "fennel", "scheme", "racket", "lua", "luadoc", "vimdoc", "vim", "markdown", "markdown_inline", "http", "json", "sql", "dart", "go", "typescript", "css", "rust"}, highlight = {enable = true, additional_vim_regex_highlighting = false}, textobjects = {select = {enable = true, keymaps = {am = "@function.outer", im = "@function.inner", ac = "@class.outer", ic = "@class.inner"}}, swap = {enable = true, swap_next = {["g>"] = "@parameter.inner"}, swap_previous = {["g<"] = "@parameter.inner"}}}, indent = {enable = true}})
end
return {{"nvim-treesitter/nvim-treesitter", lazy = true, event = "VeryLazy", dependencies = {"HiPhish/nvim-ts-rainbow2", "nvim-treesitter/nvim-treesitter-textobjects", "nvim-treesitter/nvim-treesitter-refactor"}, build = ":TSUpdate", init = _3_, config = _4_}}
