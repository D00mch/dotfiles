...
return {{"f-person/auto-dark-mode.nvim", priority = 1000, dependencies = {"nvim-tree/nvim-web-devicons", "rose-pine/neovim", "neanias/everforest-nvim", "sainnhe/edge", "rebelot/kanagawa.nvim", "ferdinandrau/lavish.nvim", "EdenEast/nightfox.nvim"}, init = _6_, config = _13_, lazy = false}}
