-- [nfnl] Compiled from .config/nvim/fnl/plugins/lsp_glance.fnl by https://github.com/Olical/nfnl, do not edit.
local function _1_()
...
return {{"DNLHC/glance.nvim", lazy = true, event = {"BufReadPost", "BufNewFile"}, cmd = {"LspInfo", "LspInstall", "LspUninstall"}, init = _1_, config = _3_}}
