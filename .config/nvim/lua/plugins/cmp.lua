...
return {{"hrsh7th/nvim-cmp", event = "InsertEnter", lazy = true, dependencies = {"hrsh7th/cmp-buffer", "hrsh7th/cmp-nvim-lsp", "hrsh7th/cmp-path", "hrsh7th/cmp-cmdline", "f3fora/cmp-spell", "PaterJason/cmp-conjure", "dcampos/cmp-snippy", "dcampos/nvim-snippy", {"MattiasMTS/cmp-dbee", ft = "sql", opts = {}}}, config = _6_}}
