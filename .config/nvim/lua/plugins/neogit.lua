...
return {{"NeogitOrg/neogit", dependencies = {"nvim-lua/plenary.nvim"}, init = _4_, cmd = "Neogit", lazy = true, opts = {kind = "split", integrations = {diffview = true, telescope = true}, disable_commit_confirmation = true, sections = {untracked = {folded = true}, recent = {folded = true}}, mappings = {status = {o = "Toggle", gr = "Reverse", ["-"] = false, q = false, v = false}, popup = {b = false, j = false, l = false, v = false}, rebase_editor = {b = false, d = false, e = false, f = false, p = false, q = false, r = false, s = false, x = false}}}, config = true}}
