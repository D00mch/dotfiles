...
local function _6_()
  ...
  local diffview_unmap = {["-"] = false, ["<esc>"] = false, ["<leader>b"] = false, ["<leader>ca"] = false, ["<leader>cb"] = false, ["<leader>co"] = false, ["<leader>ct"] = false, ["<leader>e"] = false, ["[x"] = false, ["]x"] = false, dx = false, q = false}
