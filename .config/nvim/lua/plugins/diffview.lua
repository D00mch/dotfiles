...
local function _6_()
  ...
  local diffview_unmap = {dx = false, ["<leader>ct"] = false, ["<leader>b"] = false, ["<leader>e"] = false, ["<leader>ca"] = false, ["]x"] = false, ["<leader>cb"] = false, ["[x"] = false, ["<leader>co"] = false, ["<esc>"] = false, q = false}
...
return {{"sindrets/diffview.nvim", init = _5_, config = _6_}}
