...
local function _5_()
  ...
  return term.setup({size = 20, shell = "/bin/zsh -l", on_open = _6_, open_mapping = "<space>i", hide_numbers = true, shading_factor = 2, start_in_insert = true, direction = "horizontal", persist_size = true, insert_mappings = false, shade_terminals = false, terminal_mappings = false})
end
