...
local function _3_()
  ...
  do
    ...
    kset("n", "<D-b>", search_word_under_cursor)
    kset("x", "<D-b>", search_word_under_selection)
...
return {{"nvim-telescope/telescope.nvim", dependencies = {"nvim-lua/popup.nvim", "nvim-lua/plenary.nvim", "nvim-telescope/telescope-ui-select.nvim", "ahmedkhalf/project.nvim", "debugloop/telescope-undo.nvim", "nvim-telescope/telescope-file-browser.nvim", "RomanoZumbe/harpoon"}, init = _3_, config = _8_}}
