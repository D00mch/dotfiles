  ...
  (setq-default
   ...
   '(
     ...
     (version-control :variables
                      ...
                      version-control-global-margin t) ; general vc features, eg. diff margins
     ;; ----------------------------------------------------------------
...
before packages are loaded."
  ...
  ; (setq shell-command-switch "-ic") ;; comment this to fix java support
