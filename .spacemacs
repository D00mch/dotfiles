...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     ...
     evil-cleverparens
     markdown
     org ; write project docs, organise tasks with org-mode
     syntax-checking
