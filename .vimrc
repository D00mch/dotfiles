    ...
    if exists('g:started_by_firenvim')
        ...
        "FONTSIZE AND AREA
            ...
            function! AdjustFontSizeF(amount)
              ...
              execute "set guifont=Hack_Nerd_Font_Mono:h" . s:fontsize
              call rpcnotify(0, 'Gui', 'WindowMaximized', 1)
            endfunction

            noremap  <C-=> :call AdjustFontSizeF(1)<CR>
            noremap  <C--> :call AdjustFontSizeF(-1)<CR>
            inoremap  <C-=> <Esc>:call AdjustFontSizeF(1)<CR>
            inoremap  <C--> <Esc>:call AdjustFontSizeF(-1)<CR>
            ...
            noremap  – :call AdjustLines(-1)<CR>
            inoremap  ≠ <Esc>:call AdjustLines(1)<CR>
            inoremap  – <Esc>:call AdjustLines(-1)<CR>

            function! SetAfterTimer(timer)
                set guifont=Hack_Nerd_Font_Mono:h24 lines=15 columns=90 ft=markdown
            endfunction

            call timer_start(2000, function("SetAfterTimer"))

        "BUGFIX
            autocmd BufEnter app.slack.com_* %s:\v\n+:\r:g
